...
class UserListWithoutPagnationScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _UserListWithoutPagnationScreenState();
}

class _UserListWithoutPagnationScreenState extends ConsumerState<UserListWithoutPagnationScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
